...
* Date:        Oct. 30, 2020
* Description: Draft version of the sample code for AAI
*              lecture of Industrial Design Department,
*              TU/e to demostrate sending interaction 
*              data to Data Foundry by Processing app 
*              via OOCSI service
******************************************************/
